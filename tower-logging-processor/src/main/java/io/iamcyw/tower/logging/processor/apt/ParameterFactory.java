...
import io.iamcyw.tower.logging.processor.util.Comparison;
...
final class ParameterFactory {
    ...
    public static Set<Parameter> of(final ProcessingEnvironment processingEnv, final ExecutableElement method) {
        ...
        for (VariableElement param : params) {
            ...
            final String formatClass = formatClassType == null ? null : formatClassType.getQualifiedName()
                                                                                       .toString();
            final String qualifiedType;
            if (param.asType()
                     .getKind()
                     .isPrimitive()) {
                qualifiedType = param.asType()
                                     .toString();
            } else {
                switch ((param.asType()
                              .getKind())) {
                    case ARRAY:
                        ...
                        break;
                    default:
                        qualifiedType = types.asElement(param.asType())
                                             .toString();
                        break;
                }
            }
    ...
    private static class AptParameter extends AbstractClassType implements Parameter {
        ...
        AptParameter(final ProcessingEnvironment processingEnv, final String qualifiedType, final VariableElement param,
            ...
            isFormatArg = param.getAnnotationMirrors()
                               .isEmpty() || ElementHelper.isAnnotatedWith(param, FormatWith.class) ||
        ...
        @Override
        public int hashCode() {
            return io.iamcyw.tower.logging.processor.util.Objects.HashCodeBuilder.builder()
                                                                                 .add(qualifiedType)
                                                                                 .add(param)
                                                                                 .toHashCode();
        }
        ...
        public String toString() {
            return io.iamcyw.tower.logging.processor.util.Objects.ToStringBuilder.of(this)
                                                                                 .add("name", name())
                                                                                 .add("type", asType())
                                                                                 .toString();
        }
        ...
        public int compareTo(final Parameter other) {
            return Comparison.begin()
                             .compare(asType().toString(), other.asType()
                                                                .toString())
