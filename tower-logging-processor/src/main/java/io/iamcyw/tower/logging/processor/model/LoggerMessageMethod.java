...
package io.iamcyw.tower.logging.processor.model;
...
public interface LoggerMessageMethod extends MessageMethod {
     ...
     *
     * @return the enum name of the {@linkplain Logger.Level log level}
     */
    String logLevel();

    /**
     * Indicates whether or not the {@linkplain Logger#isEnabled(Logger.Level) level} should be
